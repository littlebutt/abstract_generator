from tkinter import Tk, Entry, Button, Label, filedialog, messagebox, StringVar
...
class Window:
    ...
    def __init__(self, wname: str, width: int, height: int):
        ...
        # self.sheets_list = Listbox(self._window, selectmode='multiple', width=35)
    ...
    #     dst_btn = Button(dialog, text=u"浏览")
    #     dst_btn.place(x=220, y=50)
    #
    #     ok_btn = Button(dialog, text=u"确定")
    #     ok_btn.place(x=300, y=150, width=100)
    #
    #
    ...
    def bind_command(self):
        def check_and_bind():
            ...
            word = WordScanner(self.template_path, r"./result.docx")
            try:
                word.scan()
